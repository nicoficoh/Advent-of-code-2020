...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 15 13:41:07 2021
...
with open('/home/nico/Desktop/calendar code/Day7/list', 'r') as text:
...
for bag in bags[:-1]:                        # populate the dictionary
    ...
    if content[0] == "no other":
        ...
        for child in content:           # iterate through the bags inside the parent bag
            ...
            for i in range(number):
                                            # iterate through the amount of bags
